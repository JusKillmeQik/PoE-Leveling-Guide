...
LaunchSettings() {
  ...
  ;HotKeys
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% x230 y10, Hotkeys ;Static17

  ;Third Column Hotkey Names
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% x230 y40, Show Settings ;Static18
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Hide Notes and Guide ;Static19
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Hide Zone Images ;Static20
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Hide Level Tracker ;Static21
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Show Skill Tree ;Static22
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Hide Gem Setup ;Static23
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Show Betrayal Help ;Static24
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Show Incursion Help ;Static25
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Show Heist Help ;Static26
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Manually Cycle Zone ;Static27

  ;Third Column Offset
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% x230 y310, Offsets ;Static28

  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% x230 y340, Notes X ;Static29
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Pics X ;Static30
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Level X ;Static31
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Gems X ;Static32

  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% x345 y340, Notes Y ;Static33
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Pics Y ;Static34
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Level Y ;Static35
  Gui, Settings:Add, Text, w%offsetWidth% h%optionHeight% y+5, Gems Y ;Static36
  ...
  ;Build
  Gui, Settings:Add, Text, w80 h%optionHeight% x490 y10, Build ;Static37

  ;Fifth Column Build Options
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% x490 y40, Build Editor ;Static38
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Build Folder ;Static39
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Notes Folder ;Static40
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, New Build ;Static41
  ...
  ;Colors
  Gui, Settings:Add, Text, w80 h%optionHeight% x490 y161, Colors ;Static42

  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+9, Background ;Static43
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Red        < ;Static44
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Green     + ;Static45
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Blue        > ;Static46
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, Yellow     - ;Static47
  Gui, Settings:Add, Text, w%optionWidth% h%optionHeight% y+5, White ;Static48

  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+20, Tree Side ;Static49
  Gui, Settings:Add, Text, w%nameWidth% h%optionHeight% y+5, Tree File Name ;Static50
  ...
  Gui, Settings:Add, DropDownList, vtreeSide w%optionWidth% h%dropDownHeight% y+20 x575, % GetRightOrLeft(treeSide)
  Gui, Settings:Add, Edit, vtreeName w%optionWidth% h%optionHeight% y+5, %treeName%

  ;Cancel Button
  Gui, Settings:Add, Button, gCancelAndClose w%nameWidth% x565 y428, &Cancel
  ;Save Button
  Gui, Settings:Add, Button, gSaveAndClose w%nameWidth% x680 y428, &Save

  Gui, Settings:Show, w800 h461 NA
...
ToolTip() {
  ...
  } Else If (control = "static29") { ;Notes X Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static33") { ;Notes Y Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static31") { ;Level X Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static35") { ;Level Y Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static32") { ;Gems X Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static36") { ;Gems Y Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static30") { ;Pics X Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static34") { ;Pics Y Offset
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static42") { ;Colors
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static49") { ;Tree Side
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
  ...
  } Else If (control = "static50") { ;Tree Name
    If (oldControl = control){
      toolTime .= 1
    } Else {
      oldControl := control
